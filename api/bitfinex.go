...
func (b *BitfinexApi) connectWs() *websocket.Conn {
	...
	if err != nil || connection == nil {
		...
		//for _, symbol := range b.symbolesForSubscirbe {
			subscribtion := `{"event":"subscribe","channel":"book","symbol": "BTCUSD", "prec": "P1", "len": "100"}`
...
func (b *BitfinexApi) StartListen(ch chan Reposponse) {
